const CRON_JOBS = [
  ...
  {
    // Task #1257 — hard 30-day webhook receipt retention. This must remain a
    // scheduler job rather than an opportunistic admin/read-path sweep.
    name: "appfueled-url-retention",
    path: "/api/cron/appfueled-url-retention",
    schedule: "9 3 * * *",
    method: "GET",
    timeoutMs: 15_000,
    description: "Purge expired AppFueled URL webhook receipts (daily)",
  },
  {
