...
const rows = await sql`
  ...
  WHERE host = 'mos-maintenance-mvp-main' AND dt > '2026-08-06 18:55:00' AND message LIKE '{"clientIP"%'
...
const sm = await sql`
  ...
  WHERE host = 'mos-maintenance-mvp-main' AND dt > '2026-08-06 18:55:00'
