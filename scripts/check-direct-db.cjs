...
const ALLOWLIST = new Set([
  ...
  "app/api/customers/[customerId]/close/route.ts",
  ...
  "app/api/dev/fix-session/route.ts",
  ...
  "app/api/ghost-mode/exit/route.ts",
  ...
  "app/api/platform-admin/features/bulk-update-tiers/route.ts",
  "app/api/platform-admin/features/reorder/route.ts",
  "app/api/platform-admin/features/route.ts",
  "app/api/platform-admin/features/seed/route.ts",
  "app/api/platform-admin/impersonate/route.ts",
  "app/api/platform-admin/knowledge-base/from-ticket/route.ts",
  ...
  "app/api/platform-admin/tickets/count/route.ts",
  "app/api/platform-admin/tickets/reports/route.ts",
  "app/api/platform-admin/tickets/route.ts",
  "app/api/platform-admin/tickets/[ticketId]/route.ts",
  ...
  "app/api/platform-admin/vhi-analytics/route.ts",
  ...
  "app/api/support/tickets/count/route.ts",
  ...
  "app/api/vehicle/close/[vin]/route.ts",
  ...
  "app/api/vin/plate-lookup/route.ts",
  ...
  "lib/protractor-jobs-prewarm.ts",
  "lib/rate.ts",
  ...
  "lib/super-admins.ts",
  "lib/sync-metrics.ts",
  "lib/tekmetric-auth.ts",
  "lib/tekmetric-incremental-sync.ts",
  "lib/tekmetric-job-index.ts",
  "lib/tekmetric-jobs-prewarm.ts",
  "lib/tekmetric-migration/tokenCache.ts",
  "lib/tekmetric-sync.ts",
  "lib/tekmetric-usage-tracker.ts",
  "lib/tekmetric-webhook-subscribe.ts",
  "lib/usage.ts",
  "lib/vhi-rebuild.ts",
