      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
            <Monitor className="w-7 h-7 text-[#3c81c3]" />
            Remote Support
          </h1>
        ...
        <button
          ...
          disabled={loading}
          className="flex items-center gap-2 px-4 py-2 bg-[rgba(60,129,195,0.75)] text-white rounded-lg hover:bg-[#3c81c3] transition-colors disabled:opacity-50"
        >
      ...
      <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
        ...
        <div className="flex gap-3">
          <input
            ...
            maxLength={6}
            className="flex-1 px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#3c81c3] font-mono text-lg tracking-wider uppercase"
          />
          <button
            ...
            {devices.map((device) => (
              ...
              >
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-[rgba(60,129,195,0.75)] text-white rounded-lg hover:bg-[#3c81c3] transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm"
                >
