...
export default function PlatformUsagePage() {
  ...
  return (
    <div className="p-8 space-y-6">
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
          <div className="flex items-center gap-3 mb-2">
            <div className="p-2 bg-[rgba(60,129,195,0.15)] rounded-lg">
              <Calendar className="w-5 h-5 text-[#3c81c3]" />
            </div>
      ...
      <div className="bg-[rgba(60,129,195,0.1)] border border-[rgba(60,129,195,0.2)] rounded-xl p-4">
        <h3 className="font-medium text-[#2d6aa3] mb-2">Cost Estimation Notes</h3>
        <ul className="text-sm text-[#3c81c3] space-y-1">
