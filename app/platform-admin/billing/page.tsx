  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <RefreshCw className="w-8 h-8 animate-spin text-mos-blue" />
      </div>
    );
  }
            ...
            <div className="bg-white rounded-xl p-5 border border-gray-200 shadow-sm">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-blue-100 rounded-lg">
                  <CreditCard className="w-5 h-5 text-mos-blue" />
                </div>
                <div>
                  ...
                  <div key={plan} className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      <div className="w-32 h-2 bg-gray-100 rounded-full overflow-hidden">
                        <div
                          className="h-full bg-mos-blue rounded-full"
          ...
          <div className="p-4 border-b border-gray-200">
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <select
                ...
                className="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-mos-blue focus:border-transparent"
              >
                      ...
                      <td className="px-4 py-3">
                        <div className="text-center">
                          ...
                          <div className="w-20 h-1.5 bg-gray-100 rounded-full overflow-hidden mx-auto mt-1">
                            <div
                              className={`h-full rounded-full ${shop.vinViewCount >= shop.vinLimit ? "bg-red-500" : "bg-mos-blue"}`}
