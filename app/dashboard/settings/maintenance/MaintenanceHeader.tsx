  ...
  return (
    <div className="flex items-center justify-between">
      ...
      <div className="flex flex-wrap justify-end gap-2">
        <CopyFromLocationDropdown settingType="maintenance" onCopyComplete={() => window.location.reload()} />
        <CopySettingsToAllButton settingType="maintenance" onCopyComplete={() => window.location.reload()} />
      </div>
    </div>
  );
}
