  ...
  buckets: {
    ...
    dueSoon: [
      ...
      },
      {
        ...
        engineRiskFlag: true,
        engineRiskReason: "Engine flagged for accelerated oil wear (long OEM oil interval).",
      },
    ],
    upcoming: [
      {
        ...
        protractorDeferredId: null,
        engineRiskFlag: true,
        engineRiskReason: "Engine flagged for accelerated oil wear. Active OEM interval is 7,500 mi.",
      },
      {
        key: "tires_rotate",
