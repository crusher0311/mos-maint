...
*   **API Sniffer (Dev Tools)**: A platform-admin-only feature in the Detect Dog extension for capturing and analyzing API traffic from integrated systems. Captures are uploaded to a server-side endpoint for storage and analysis.
